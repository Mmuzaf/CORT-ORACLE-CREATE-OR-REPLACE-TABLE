...
/*
  Description: Schema installation script using SQLPlus Extensions
  ----------------------------------------------------------------------------------------------------------------------     
  Release | Author(s)         | Comments
  ----------------------------------------------------------------------------------------------------------------------  
  14.01.1 | Rustam Kafarov    | Renamed from cort_schema
  ----------------------------------------------------------------------------------------------------------------------  
*/


DEFINE table_exists = "SELECT COUNT(*) FROM user_tables WHERE table_name" 
...
@IF "(&table_exists = 'CORT_JOB_LOG') = 1"
@THEN
...
@IF "(&table_exists = 'CORT_OBJECTS') = 0"
@THEN{
...
DEFINE sequence_exists = "SELECT COUNT(*) FROM user_sequences WHERE sequence_name" 

@IF "(&sequence_exists = 'CORT_LOG_SEQ') = 0"
@THEN 
CREATE SEQUENCE cort_log_seq;
@ENDIF

@IF "(&sequence_exists = 'CORT_OBJ_SEQ') = 0"
@THEN 
